...
function createRecords(Restaurant){
  return Restaurant.remove().exec()
    .then(function(){
      return Restaurant.create(getRestaurants());
    })
    .then(function(res){ console.log('Created Restaurants'); })
