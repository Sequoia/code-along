...
noremap! <D-Left> <Home>
inoremap <Plug>(simple-todo-mark-as-undone) :s/^\(\s*[-+*]\?\s*\)\[x\]/\1[ ]/
inoremap <Plug>(simple-todo-mark-as-done) :s/^\(\s*[-+*]\?\s*\)\[ \]/\1[x]/
inoremap <Plug>(simple-todo-new) [ ] 
...
vnoremap <Plug>(simple-todo-mark-as-undone) :s/^\(\s*[-+*]\?\s*\)\[x\]/\1[ ]/
nnoremap <Plug>(simple-todo-mark-as-undone) :s/^\(\s*[-+*]\?\s*\)\[x\]/\1[ ]/
vnoremap <Plug>(simple-todo-mark-as-done) :s/^\(\s*[-+*]\?\s*\)\[ \]/\1[x]/
nnoremap <Plug>(simple-todo-mark-as-done) :s/^\(\s*[-+*]\?\s*\)\[ \]/\1[x]/
nnoremap <Plug>(simple-todo-new) a[ ] 
...
set ruler
set runtimepath=~/.vim,~/vim_local_bundles/Vundle.vim,~/vim_local_bundles/syntastic,~/vim_local_bundles/powerline/powerline/bindings/vim/,~/vim_local_bundles/vim-surround,~/vim_local_bundles/vim-fugitive,~/vim_local_bundles/vim-gitgutter,~/vim_local_bundles/vim-unimpaired,~/vim_local_bundles/undotree,~/vim_local_bundles/ctrlp.vim,~/vim_local_bundles/YankRing.vim,~/vim_local_bundles/vim-projector,~/vim_local_bundles/vim-jade,~/vim_local_bundles/nerdtree,~/vim_local_bundles/nerdcommenter,~/vim_local_bundles/ultisnips,~/vim_local_bundles/vim-snippets,~/vim_local_bundles/vim-simple-todo,/usr/local/Cellar/macvim/7.4-73_1/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/7.4-73_1/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/7.4-73_1/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/vim_local_bundles/Vundle.vim/after,~/vim_local_bundles/syntastic/after,~/vim_local_bundles/powerline/powerline/bindings/vim//after,~/vim_local_bundles/vim-surround/after,~/v
set shiftwidth=2
set showcmd
set smartcase
set smarttab
...
set ttimeout
set ttimeoutlen=200
set wildignore=*/tmp/*,*.so,*.swp,*.zip,*\\tmp\\*,*.swp,*.zip,*.exe
set wildmenu
set window=36
set nowritebackup
...
silent only
cd ~/projects/code-along/my-express-app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/projects/code-along/http-server.js
badd +1 ~/projects/code-along/http-greet-route.js
badd +11 ~/projects/code-along/myproject/greeter.js
badd +1 greeter.js
badd +7 ~/projects/code-along/req.params.js
badd +1 req.params.js
badd +1 req.query.js
badd +1 regex-route.js
badd +1 wildcard-route.js
badd +1 req.params.and.query.js
badd +1 foo.js
badd +173 ~/.viminfo
badd +0 handle-errors.js
badd +1 ~/tmp/foo.jade
badd +2 ~/tmp/foo.html
badd +1 out.html
badd +0 ~/tmp/out.html
argglobal
silent! argdel *
edit ~/projects/code-along/http-greet-route.js
...
silent! normal! zE
let s:l = 24 - ((16 * winheight(0) + 18) / 37)
